/*
  TwoWire2.cpp - TWI/I2C library for Wiring & Arduino
...
void (*TwoWire2::user_onRequest)(void);
void (*TwoWire2::user_onReceive)(int);
...
void TwoWire2::onReceiveService(uint8_t* inBytes, int numBytes)
{
...
void TwoWire2::onRequestService(void)
{
  // don't bother if user hasn't registered a callback
  if(!user_onRequest){
    return;
